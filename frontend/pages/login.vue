...
useSeoMeta({
  title: 'Log In | dsaflash.cards',
  description: 'Log in to dsaflash.cards to track your learning progress with spaced repetition.',
  robots: 'noindex, nofollow',
})
useHead({
  link: [{ rel: 'canonical', href: 'https://dsaflash.cards/login' }],
})
