      ...
      <template v-if="quizComplete && submitResult">
        <div class="text-center py-8">
          ...
          <div v-if="!isLoggedIn" class="max-w-sm mx-auto rounded-xl border border-purple-100 bg-purple-50 px-6 py-5 mb-6 text-left">
            ...
            <p class="text-sm text-purple-700 mb-4">Sign up to save your progress and unlock spaced repetition flashcards — it's free.</p>
            <NuxtLink
              to="/signup"
              class="inline-block px-5 py-2.5 bg-purple-600 text-white text-sm font-semibold rounded-lg hover:bg-purple-700 transition"
            >
              Sign up — it's free
            </NuxtLink>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <NuxtLink
              ...
              class="px-6 py-3 border border-purple-300 text-purple-700 font-semibold rounded-xl hover:bg-purple-50 transition text-center"
            >
            ...
            <NuxtLink
              ...
              class="px-6 py-3 bg-purple-600 text-white font-semibold rounded-xl hover:bg-purple-700 transition text-center"
            >
              Next lesson
            </NuxtLink>
          </div>
                ...
                isCorrectOption(idx)
                  ...
                  : isWrongSelected(idx)
                    ...
                    : showResult
                      ...
                      : 'border-gray-200 hover:border-purple-400 hover:bg-purple-50 text-gray-800 cursor-pointer'
              ]"
            >
          ...
          <div v-if="showResult" class="mt-6">
            ...
            <div class="flex justify-end">
              <button
                v-if="!submitting"
                @click="nextQuestion"
                class="px-6 py-2.5 bg-purple-600 text-white font-semibold rounded-xl hover:bg-purple-700 transition"
              >
